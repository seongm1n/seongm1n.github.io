...
처음 프리코스를 시작할때는 스터디를 할 생각은 없었다. 딱히 들어갈만한 스터디가 없을 것 같기도 했고, 스터디 할 시간에 혼자 공부하는 것이 더 도움될 거라는 안일한 생각도 있었다.

![3](/assets/img/precorse/study.png)

우연히 우아한프리코스 디스코드에서 근처에서 진행하는 스터디를 발견했고, 약간의 고민 끝에 "밑져야 본전이지 뭐" 하는 생각을 가지고 들어갔다.

결론부터 말하면 정말 잘한 선택인 것 같다. 어쩌면 스터디를 들어오기 위해 프리코스를 진행하는게 아닐까 하는 생각이 들정도로 많은 도움이 되고 있다.

생각보다 다양한 배경을 가진 분들이 오셨고, 다들 너무 대단하신 분들이였다. 코드를 리뷰받고 리뷰하는 과정에서 배워가는 점도 많았지만 다른분들이 공부하는 방식, 개발을 대하는 태도 등 많은 것들을 배울 수 있었다.

아직 스터디는 한번밖에 진행하지 않았고, 앞으로 어떻게 진행될지 모르지만 스터디에서의 목표를 세웠다. 당장 내 실력이 급 상승해서 다른분들에게 엄청난 정보를 주거나 가르침을 주는건 당연히 안될 것 같았다. 남은 프리코스 기간동안 꾸준히 성장하는 모습을 보여줘서 적어도 ```쟤한테 지는건 쫌...``` 하는 동기부여라도 주고 싶다.

## 회고

처음에는 프리코스도 선발의 과정중 하나로 생각했다. 거기에 사실상 현시점 백엔드에서 가장 인기가 많은 캠프이다보니 무의식적으로 ```내가 뽑히겠어?``` 라는 생각이 있었던 것 같다.

![3](/assets/img/precorse/me.png)

하나의 어떻게 보면 간단한 과제를 일주일동안 해결하고 많은 사람들에게 코드리뷰를 받고 나도 코드리뷰를 해주면서 가장 처음 느낀점은 내가 생각보다 다른사람의 코드를 리뷰했던 적이 거의 없다는 생각을 했다. 몇번 해본 코드리뷰 마저도 이 코드가 어떻게 돌아가는지 보다는 이 코드가 돌아가는지에 더 집중 했었던 것 같다.